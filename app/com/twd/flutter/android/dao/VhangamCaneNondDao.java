...
public class VhangamCaneNondDao {
	public VarietyHangamCaneResponse varietyHangamCaneNond(VarietyHangamCaneResponse vhResponse, Connection conn) {
	    ...
	    try {
	        String sql = "select t.ResourceName,t.Value1,t.Value2,t.Value3,t.Value4,t.Value5 from androidapp.agri_mis_1_u_current t where t.flag=1";
	...
	public GatHangamCurrentCaneResponse gatHangamCaneNond(GatHangamCurrentCaneResponse ghResponse, Connection conn) {
		GatHangamCurrentCaneResponse ghCaneResponse = new GatHangamCurrentCaneResponse();
		    ...
		    try {
		        String sql = "select t.ResourceName,t.Value1,t.Value2,t.Value3,t.Value4,t.Value5 from androidapp.agri_mis_1_u_current t where t.flag=2";
		        try (PreparedStatement pst = conn.prepareStatement(sql)) {
	...
	public MonthHangamCurrentCaneResponse monthHangamCaneNond(MonthHangamCurrentCaneResponse mhResponse,
	    ...
	    try {
	        String sql = "select t.ResourceName,t.Value1,t.Value2,t.Value3,t.Value4,t.Value5 from androidapp.agri_mis_1_u_current t where t.flag=33";
	        try (PreparedStatement pst = conn.prepareStatement(sql)) {
	...
	public MonthVarietyCurrentCaneResponse monthVarietyCaneNond(MonthVarietyCurrentCaneResponse mvResponse,
	    ...
	    try {
	        String sql = "select t.ResourceName,t.Value1,t.Value2,t.Value3,t.Value4,t.Value5 from androidapp.agri_mis_1_u_current t where t.flag=44";
	        try (PreparedStatement pst = conn.prepareStatement(sql)) {
