...
public class ConstantVeriables {
	public static final String APP_T_BILL_HEADER = "APP_T_BILL_HEADER";//APP_
	public static final String APP_T_BILL_DETAILS = "APP_T_BILL_DETAILS";//APP_
	...
	public static final String lblKg = "किलो";
	public static final String lblQtl = "क्विंटल";
	...
	public static String plantFilePath=baseFilePath+"plantationimage/";
	
	public static String statusSubmit="विनंती";
	public static String lbl_season="सिझन";
	public static String usnondHeading="ऊस नोंद";
	public static String lbl_nplotno = "नोंद क्र.";
	public static String lbl_farmercodeno="कोड नंबर";
	public static String lbl_farmername="नाव";
	public static String lbl_serveno="सर्व्हे नंबर";
	public static String lbl_lagan_date="लागण तारीख";
	public static String lbl_hungam="ऊस प्रकार ";
	public static String lbl_usjat="ऊसाची जात";
	public static String lbl_nond_area="नोंद  क्षेत्र";
	public static String lblhectro="हे.";
	public static String lblr="आर.";
	public static String[] formStatus= new String[] {"बाद फॉर्म", "इंटीमेशन", "फिल्ड व्हिजिट", "फिल्ड रिव्हिजिट", "गट क्लार्क मंजूर", "गट क्लार्क नामंजूर", "ओ. सि.  मंजूर", "ओ. सि.  नामंजूर","","","","फिल्ड व्हिजिट बाकी","कागदपत्र प्रलंबित"};//0 not real
	...
	public static String weightSlipTableName="WB_T_WEIGHT_SLIP"; //WB_T_WEIGHT_SLIP
	...
	public static String defaultArea = "0.00";
	public static String defaultCount = "0";
	public static String srno = "अ.क्र.";
	public static String eno = "इ .नं.";
	...
	public static String fromTimeRawana="13:00";
	...
	public static String akshari = "अक्षरी : रू.";
	// Report Field End
	...
	public static String cardType="कार्ड प्रकार";
	public static String unit="प्रमाण (क्विं)";
	public static String weight="वजन";
	public static String bag="पिशवी";
	public static String rate="दर";
	public static String yes="होय";
	public static String no="नाही";
	public static String tenderbag="टेंडर पिशवी";
	public static final String lblRemaning = "शिल्लक";
	public static final String lblBillNO = "मेमो नं.";
	public static final String QRCode = "QR कोड";
	public static final String ErrorIntimationformnotfound = "सदर फॉर्म लॉक झालेला आहे.";
	public static String unitTender=" / क्विंटल";
	public static String unitSugar=" / किलो";
	public static String unitBag=" / नग";
	public static String unitTransCharge=" / बॅग";
	public static String cardTypeEmployee="3";
	public static String masterCard="मास्टर कार्ड";
	public static String lblProductName="वस्तूचे नांव";
	...
	public static String lblsurveno="सर्व्हे नंबर";
	public static String lblInwardno="आवक नंबर";
	public static String errorNotAgriOvershare="हे कार्य फक्त  Agri Overshare करू शकतात , अधिक माहिती साठी शेती विभागाशी संपर्क साधा.";
	public static String errorNotSectionAssign="तुम्हाला कामकाजासाठी कोणताही Section  दिलेला नाही .";
	public static String errorReasons="आपण नजर चुकीने Approve केले होते.";
	public static String errorReasonsRequest = "आपण फॉर्म दुरुस्तीसाठी मागणी केली आहे";
	public static String intimationno = "इंटीमेशन नंबर";
	public static String visitno="व्हिजिट नंबर";
	public static String lblavakno="आवक नं.";
	public static String lblplantationdate="लागण दि.";
	public static String lblCaneVilleage="उस गाव";
	public static String lblarea="क्षेत्र";
	public static String lblhangam="हंगाम";
	public static String lblvarity="ऊस जात";
	public static String lblsaritype="सरी पद्धत";
	public static String lblirrigationtype="सिंचन";
	public static String lblrope="रोपे";
	public static String lbldrip="ठिबक";
	public static String lblphoto="फोटो";
	public static String lblchitboy="चीटबॉय";
	public static String lblflag="शेरा";
	public static String lblcount="संख्या";
	public static String lblfiledvisitno="व्हिजिट नं.";
}
